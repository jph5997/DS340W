...
load("statcast_query_2015.RData")
load("statcast_query_2016.RData")
load("statcast_query_2017.RData")
load("statcast_query_2018.RData")
load("statcast_query_2019.RData")
# Process Data ------------------------------------------------------------
...
save(unik_batters, file= "unik_batters.RData")
save(unik_pitchers, file= "unik_pitchers.RData")
save(unik_catchers, file= "unik_catchers.RData")
save(unik_umpires, file= "unik_umpires.RData")
...
save(pitch_data, file= "pitch_data.RData")
...
save(xR_data, file = "xR_data.RData")
