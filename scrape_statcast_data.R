...
save(statcast_query_2015, file = "statcast_query_2015.RData")
save(statcast_query_2015, file = "statcast_query_2016.RData")
save(statcast_query_2015, file = "statcast_query_2017.RData")
save(statcast_query_2015, file = "statcast_query_2018.RData")
save(statcast_query_2015, file = "statcast_query_2019.RData")
